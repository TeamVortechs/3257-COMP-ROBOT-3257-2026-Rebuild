...
public class VisionLogless extends SubsystemBase {
  ...
  public VisionLogless(VisionConsumer consumer, PowerModuleIO powerModuleIO) {
    ...
    this.photonCameraRight = new PhotonCamera(photon1Name);
    this.leftEstimator = new PhotonPoseEstimator(aprilTagLayout, robotToPhoton0);
    this.rightEstimator = new PhotonPoseEstimator(aprilTagLayout, robotToPhoton1);
  }
